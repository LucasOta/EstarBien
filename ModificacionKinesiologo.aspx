<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ModificacionKinesiologo.aspx.vb" Inherits="ModificacionKinesiologo" %>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-inverse" id="nav">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item">
					<a class="nav-link active" href="./ListadoKinesiologos.aspx" target= "_self">Kinesiologos</a>
				</li>
                <li class="nav-item">
        ...
        <table class ="table table-hover">
            ...
            <tr>
                ...
                <th>
                    ...
                    <asp:RequiredFieldValidator ID="camp_req_Cel" runat="server" ControlToValidate="txt_NyA" ErrorMessage="RequiredFieldValidator">Por favor complete este campo.</asp:RequiredFieldValidator>
                </th>
            </tr>
            <tr>
                <th>Email</th>
            ...
            <tr>
                ...
                <th>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txt_Titulo" ErrorMessage="RequiredFieldValidator">Por favor complete este campo.</asp:RequiredFieldValidator>
                </th>
            </tr>
            <tr>
                <th>Especialidad</th>
                <th>
                    <asp:TextBox ID="txt_Especialidad" runat="server"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txt_Especialidad" ErrorMessage="RequiredFieldValidator">Por favor complete este campo.</asp:RequiredFieldValidator>
                </th>
            </tr>
