<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ModificarObraSocial.aspx.vb" Inherits="ModificarObraSocial" %>
		    ...
		    <div class="col-md-6 ">
                <table class ="table ">
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="BTN_Modificar" CssClass="btn btn-outline-dark" runat="server" Text="Modificar Obra Social" />
                        </td>
                    </tr>
                </table>
            </div>
