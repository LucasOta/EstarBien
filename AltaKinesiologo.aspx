<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AltaKinesiologo.aspx.vb" Inherits="AltaKinesiologo" %>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-inverse" id="nav">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item">
					<a class="nav-link active" href="#" target= "_self">Kinesiologos</a>
				</li>
                <li class="nav-item">
