<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Planes.aspx.vb" Inherits="Planes" %>
...
<body>
    ...
    <h3>
        <asp:Label ID="lbl_OS" runat="server" Text="Label"></asp:Label>
    </h3>
        </br>
        <h4>Agregar Plan a Obra Social</h4>
        <div class="row">
		    <div class="col-md-6 ">
                <table class ="table ">
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="BTN_Agregar" CssClass="btn btn-outline-dark" runat="server" Text="Agregar Plan" />
                        </td>
                    </tr>
                </table>
            </div>
                    ...
                    <asp:Repeater ID="Repeater1" runat="server">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td><a href="./ModificarPlan.aspx?ID=<%#Container.DataItem("ID_Plan")%>&IDos=<%#Container.DataItem("ID_ObraSocial")%>">Modificar</a></td>
                                <td><a href="./BajaPlan.aspx?ID=<%#Container.DataItem("ID_Plan")%>&IDos=<%#Container.DataItem("ID_ObraSocial")%>" OnClick="if (! confirm('¿Está seguro que desa borrar este plan?')) return false;">Eliminar</a> </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
        ...
        <asp:Button CssClass="btn btn-outline-dark" ID="Volver_btn" runat="server" Text="Volver" CausesValidation="false" />
    </form>
</body>
</html>
